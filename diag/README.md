...
| load | 1 | 2 | 3 | 4 | 5 | 6 |
|---|---|---|---|---|---|---|
| with both fixes | [`1`](runs/collider-both-load1.log) | [`2`](runs/collider-both-load2.log) | [`3`](runs/collider-both-load3.log) | [`4`](runs/collider-both-load4.log) | [`5`](runs/collider-both-load5.log) | [`6`](runs/collider-both-load6.log) |
| its pictures | [`1`](../imgs/collider-both-load1.png) | [`2`](../imgs/collider-both-load2.png) | [`3`](../imgs/collider-both-load3.png) | [`4`](../imgs/collider-both-load4.png) | [`5`](../imgs/collider-both-load5.png) | [`6`](../imgs/collider-both-load6.png) |
...
`cactus` — so they compare one by one from one load to the next, and with the two series taken without
this mod.
